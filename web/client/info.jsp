			...
			<tr>
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td><img src="${pageContext.request.contextPath }/client/images/mystore.png" width="900" height="84" />
								<table width="100%%" border="0" cellspacing="0" style="background: #333e43">
									<tr>
										<td width="30%">
