			...
			<tr>
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td>
								<img src="${pageContext.request.contextPath}/client/images/mystore.png" width="900" height="89" />
								<table width="100%" border="0" cellspacing="0">
<%--									<tr>--%>
<%--										<td>--%>
													...
													<tr>
														...
														<td width="10%">
															...
															<a href="${pageContext.request.contextPath}/changeCart?id=${entry.key.id}&count=0"
															   style="color:#de8ab8; font-weight:bold" onclick="javascript:return cart_del()">X</a>
														</td>
													</tr>
												</table>
											...
											<table cellspacing="1" class="carttable">
												<tr>
													<td style="text-align:right; padding-right:40px;">
														<font style="color:#ffcd98; font-weight:bold">合计：&nbsp;&nbsp;${total}元</font>
													</td>
												</tr>
											</table>
