...
<body class="main" style="background:#333e43">
	...
	<div id="divcontent" style="background: #333e43;border-radius: 10px">
		<form action="${pageContext.request.contextPath}/login" method="post">
			<table width="900px" border="0" cellspacing="0" style="border-radius: 10px">
				<tr>
					<td style="background: #333e43;padding:30px"><div style="background: #2f3243;height:470px;border-radius: 10px">
							<b style="font-size: 15px">&nbsp;&nbsp;首页&nbsp;&raquo;&nbsp;个人用户登录</b>
							<div>
								<table width="85%" border="0" cellspacing="0">
									<tr>
										<td>
											<div id="logindiv" style="background: #2F3F5B">
